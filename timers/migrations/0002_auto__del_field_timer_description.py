...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Timer.description'
        db.delete_column('timers_timer', 'description')


    def backwards(self, orm):
        # Adding field 'Timer.description'
        db.add_column('timers_timer', 'description',
                      self.gf('django.db.models.fields.CharField')(blank=True, null=True, max_length=1000),
                      keep_default=False)
    ...
    models = {
        ...
        'categories.category': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '1000', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Category']", 'blank': 'True', 'null': 'True'}),
        ...
        'timers.interval': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '1000', 'null': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'to': "orm['tags.Tag']", 'db_index': 'True', 'null': 'True'}),
