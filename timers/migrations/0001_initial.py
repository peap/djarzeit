...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timers_interval', (
            ...
            ('start', self.gf('django.db.models.fields.DateTimeField')(blank=True, auto_now_add=True)),
            ('end', self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True)),
            ('notes', self.gf('django.db.models.fields.CharField')(blank=True, null=True, max_length=1000)),
        ))
        ...
        db.create_table(m2m_table_name, (
            ...
            ('tags', models.ForeignKey(orm['tags.tags'], null=False))
        ))
    ...
    models = {
        ...
        'timers.interval': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '1000'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'db_index': 'True', 'null': 'True', 'symmetrical': 'False', 'to': "orm['tags.Tags']"}),
