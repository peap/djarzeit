...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timer.archived'
        db.add_column('timers_timer', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timer.archived'
        db.delete_column('timers_timer', 'archived')
    ...
    models = {
        ...
        'categories.category': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['categories.Category']", 'null': 'True'}),
        ...
        'timers.interval': {
            'Meta': {'object_name': 'Interval', 'ordering': "['-start']"},
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['tags.Tag']", 'db_index': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        'timers.timer': {
            'Meta': {'object_name': 'Timer', 'ordering': "['name']"},
